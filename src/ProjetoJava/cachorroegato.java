...
public class cachorroegato {
	...
	//DECLARA��O DE PARAMETR�S
		...
		public String toString() {
			return  this.tipo+ " -> " + this.nome + " -> " + this.sexo + ", "+ this.porte + ", " + this.castrado+ ", "+ this.vacinado +", "+ this.cor + "// Vive bem em casa? "+ this.Casa + " // Em Apartamento? " + this.Apto + "// RA�A: " + this.raca+" PORTE: "+this.porte;
		}
}
...
//OBJETOS
        ...
        cachorroegato cachorro1 = new cachorroegato("CACHORRO","Bini","Macho","Castrado","Vacinado","Sim","N�o","Marrom","Dobermann","Grande");
        cachorroegato cachorro2 = new cachorroegato("CACHORRO","Amelia","Femea","N�o Castrado","Vacinado","Sim","N�o","Preto","Viralata","Pequeno");
        cachorroegato cachorro3 = new cachorroegato("CACHORRO","Claudinho","Macho"," N�o Castrado","N�o Vacinado","N�o","Sim","Branco/Preto","Dalmata","Pequeno");
        cachorroegato cachorro4 = new cachorroegato("CACHORRO","Estrela","Femea","Castrado","N�o Vacinado","Sim","N�o","Branco","Viralata","Grande");
        
        cachorroegato	gato1	= new cachorroegato("GATO","Gio","Macho","Castrado","Vacinado","Sim","N�o","Branco","Viralata","Grande");
        cachorroegato	gato2	= new cachorroegato("GATO","Shie","Femea","N�o Castrado","Vacinado","N�o","N�o","Listrado","Viralata","Pequeno");
        cachorroegato	gato3	= new cachorroegato("GATO","Andreia","Femea","Castrado","N�o Vacinado","N�o","Sim","Marrom","Viralata","Grande");
        cachorroegato	gato4	= new cachorroegato("GATO","Kevin","Macho","N�o Castrado","N�o Vacinado","N�o","N�o","Preto","Viralata","Grande");
...
//ADICIONAMENTO OBJETOS DENTRO DO ARRAYLIST
        ...
        System.out.println("==================================================================================");
        System.out.println("==========================BEM-VINDE � <VIRALA-T�/>!!!=============================");
        System.out.println("==================================================================================\n\n");
        System.out.println("Voc� deseja adotar Cachorro ou Gato?\n");
        System.out.println("(1)CACHORRO\n");
        System.out.println("(2)GATO\n");
        System.out.println("Op��o: ");animal=input.nextInt();
        
switch(animal){
        case 1: //CACHORROS
        	//IMPRIME LISTA DE CACHORROS DISPON�VEIS
        	System.out.println("\n\nLista de Cachorrinhos para ado��o: ");
        	...
        	System.out.println("\n-----------------------------------");
        		...
        		switch(op) {
        			case 1:
                        ...
                        if(aq1[0] == null) {
                        	System.out.println("Caracter�sticas n�o correspondem...");
                        }		
                        else {
                        	for(int k = 0 ; k < qtd; k++) {
                ...
                if(nomedog == l) {
                	...
                	aj++;
                		...
                		System.out.println("Parab�ns aos Envolvidos agora o(s) "+ aq1[o] + " Tera um novo lar! o seu Lar!");
                break;
        ...
        case 2://GATOS
        	//IMPRIME LISTA DE GATOS DISPON�VEIS
        	System.out.println("\n\nLista de Gatinhos para ado��o: ");
        	...
        	System.out.println("\n-----------------------------------");
                ...
                if(nomecat == l) {
                	...
                	aj++;
                		...
                		System.out.println("Parab�ns aos Envolvidos agora o(s) "+ aq2[o] + " Tera um novo lar! o seu Lar!");
                break;
